...
def main(args, cf):
    ...
    if args.job != "xval":
        checkpoint = torch.load(join(args.pdir, cf.export_params.save_dir, args.job,'best_outputs', f'f{args.fold}', "checkpoint.pth.tar"), map_location=torch.device('cpu'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--job', type=str, default='xval', help='[attempts, xval]')
