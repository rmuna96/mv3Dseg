...
class IterationMetric(Metric):
    ...
    def __call__(self, y_pred: TensorOrList, y: Optional[TensorOrList] = None, **kwargs: Any):  # type: ignore
        """
    ...
    def _compute_list(self, y_pred: TensorOrList, y: Optional[TensorOrList] = None, **kwargs: Any):
        """
    ...
    @abstractmethod
    def _compute_tensor(self, y_pred: torch.Tensor, y: Optional[torch.Tensor] = None, **kwargs: Any):
        """
